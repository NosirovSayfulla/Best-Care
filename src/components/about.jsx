...
//         className='text-[#2F4896] font-semibold text-[56px] text-center'
//         id='about'
//       >
//         {t("title")} <span className='text-[#000000]'>{t("title1")}</span>
//       </motion.h1>

//       {/* Asosiy kontent qismi */}
//       <section className='flex justify-between items-center mt-10 ' id='left'>
//         {/* Chapdagi rasm */}
//         <motion.div
...
//             className='font-medium text-[24px] bg-[#2F4896] px-[30px] text-white rounded-4xl w-[204px] h-[57px]'
//           >
//             {t("more")}
//           </motion.button>
//         </motion.div>
...
<>
{/* desktopVersion */}
    <section className="p-5 md:p-10 lg:p-20 hidden md:block">
      {/* Sarlavha animatsiyasi */}
      <motion.h1
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="text-[#2F4896] font-semibold text-[32px] md:text-[48px] lg:text-[56px] text-center"
        id='about'
      >
        {t("title")} <span className="text-[#000000]">{t("title1")}</span>
      </motion.h1>
      ...
      {/* Asosiy kontent qismi */}
     <section className="flex flex-col lg:flex-row justify-between items-center mt-10 gap-10" id='bestcare'>
    ...
    {/* MobileVrrsion */}
    <section className="p-5 md:p-10 lg:p-20 flx flex-col block md:hidden">
      {/* Sarlavha animatsiyasi */}
     ...
     <section className="  grid grid-cols-1  mt-10 gap-10" id='bestcare'>
        ...
        <motion.h1
                ...
                id='about'
        >
          {t("title")} <span className="text-[#000000] sm:text-center">{t("title1")}</span>
        </motion.h1>
        {/* Chapdagi rasm */}
        <motion.div
          initial={{ opacity: 0, x: -100 }}
